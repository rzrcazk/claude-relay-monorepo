...
export const PROVIDER_CONFIGS = {
  ...
  // 预定义供应商 - Anthropic 兼容 (阿里云百炼)
  dashscope: {
    name: '阿里云百炼',
    description: '阿里云百炼平台提供的大语言模型服务 (Anthropic 兼容模式)',
    icon: 'from-orange-400 to-yellow-500',
    type: 'anthropic' as const,
    baseUrl: 'https://coding.dashscope.aliyuncs.com/apps/anthropic',
    models: ['qwen3.5-plus', 'kimi-k2.5', 'glm-5'],
    helpText: '请前往 https://dashscope.aliyuncs.com/ 注册并获取 API Key',
    transformer: 'claude-to-anthropic' as const,
    isPreset: true
  },
  // 预定义供应商 - Anthropic 兼容 (通用)
  anthropic_custom: {
    name: 'Anthropic 兼容',
    description: '兼容 Anthropic API 的自定义服务',
    icon: 'from-purple-500 to-indigo-600',
    type: 'anthropic' as const,
    baseUrl: '',
    models: [],
    helpText: '请输入兼容 Anthropic API 格式的服务端点和密钥',
    transformer: 'claude-to-anthropic' as const,
    isPreset: false
  },
  // 自定义 OpenAI 兼容服务
